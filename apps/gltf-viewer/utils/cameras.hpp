...
// Add an interface CameraController as base class for FirstPersonCameraController and TrackballCameraController.
// In these two classes, use the C++11 keywork override to mark the overrided virtual methods.
